...
const PROXY_ROUTES: &[(&str, &str, &str)] = &[
    ...
    // ── Фаза 3.2 (§11.7.9): поверхні, які ДО того мали `classify_request -> None`
    ("POST", "/api/v1/products", "products"),
    ("PUT", "/api/v1/products/11111111-1111-1111-1111-111111111111", "products"),
    ("DELETE", "/api/v1/products/11111111-1111-1111-1111-111111111111", "products"),
    ("POST", "/api/v2/products", "products"),
    ("PUT", "/api/v2/products/11111111-1111-1111-1111-111111111111", "products"),
    ("DELETE", "/api/v2/products/11111111-1111-1111-1111-111111111111", "products"),
    ("POST", "/api/v2/products/11111111-1111-1111-1111-111111111111/images", "product_images"),
    (
        "DELETE",
        "/api/v2/products/11111111-1111-1111-1111-111111111111/images/11111111-1111-1111-1111-111111111111",
        "product_images",
    ),
    ("POST", "/api/v1/products/11111111-1111-1111-1111-111111111111/images", "product_images"),
    (
        "DELETE",
        "/api/v1/products/11111111-1111-1111-1111-111111111111/images/11111111-1111-1111-1111-111111111111",
        "product_images",
    ),
    ("POST", "/api/v2/products/11111111-1111-1111-1111-111111111111/barcodes", "barcodes"),
    (
        "DELETE",
        "/api/v2/products/11111111-1111-1111-1111-111111111111/barcodes/11111111-1111-1111-1111-111111111111",
        "barcodes",
    ),
    ("POST", "/api/v1/products/11111111-1111-1111-1111-111111111111/barcodes", "barcodes"),
    (
        "DELETE",
        "/api/v1/products/11111111-1111-1111-1111-111111111111/barcodes/11111111-1111-1111-1111-111111111111",
        "barcodes",
    ),
    ("POST", "/api/v1/categories", "categories"),
    ("PUT", "/api/v1/categories/11111111-1111-1111-1111-111111111111", "categories"),
    ("DELETE", "/api/v1/categories/11111111-1111-1111-1111-111111111111", "categories"),
    ("POST", "/api/v2/categories", "categories"),
    ("PUT", "/api/v2/categories/11111111-1111-1111-1111-111111111111", "categories"),
    ("DELETE", "/api/v2/categories/11111111-1111-1111-1111-111111111111", "categories"),
    ("POST", "/api/v1/suppliers", "suppliers"),
    ("PUT", "/api/v1/suppliers/11111111-1111-1111-1111-111111111111", "suppliers"),
    ("DELETE", "/api/v1/suppliers/11111111-1111-1111-1111-111111111111", "suppliers"),
    ("POST", "/api/v1/print-templates", "print_templates"),
    ("PUT", "/api/v1/print-templates/11111111-1111-1111-1111-111111111111", "print_templates"),
    ("DELETE", "/api/v1/print-templates/11111111-1111-1111-1111-111111111111", "print_templates"),
    (
        "POST",
        "/api/v1/print-templates/11111111-1111-1111-1111-111111111111/set-default",
        "print_templates",
    ),
    ("PUT", "/api/v1/settings", "system_settings"),
    ("PUT", "/api/v1/settings/company_name", "system_settings"),
    ("POST", "/api/v2/prro/shift/open", "prro_shifts"),
    ("POST", "/api/v2/prro/shift/close", "prro_shifts"),
