...
//! TORGASHKA_RUST_AUTH), як у інвойсів (група 3).
...
/// окремий пул — незалежно від TORGASHKA_RUST_AUTH.
...
pub struct ConfirmBody {
    pub status: String,
    pub exchange_items: Option<Vec<torgashka_domain::return_invoices::ExchangeItemCreateInput>>,
}
