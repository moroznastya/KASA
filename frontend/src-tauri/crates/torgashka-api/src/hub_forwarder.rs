...
//!
//! Шлях форвардера — ВЛАСНА PG-черга вузла (`hub_outbox`) плюс спільний
//! HTTP-виклик (`sync_push::post_push_batch`): він не торкається ні
//! SQLite-черги каси, ні її налаштувань. E7 прибрав і сам ґейт Фази 3.8 —
//! режимів вузла більше не існує, тож форвардер не може бути «заблокований
//! режимом» за визначенням.
//!
