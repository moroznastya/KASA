...
//!
//! Ізоляція даних: `XDG_DATA_HOME=<dir>` → БД у `<dir>/kasa-pos/offline.db`.
//!
//! Підкоманди:
...
//!
//! Приклади:
//!   XDG_DATA_HOME=/tmp/kasa-stage5 \
//!     cargo run -p kasa-infrastructure --example offline_queue -- save '{"receipt_type":"sale"}'
//!   XDG_DATA_HOME=/tmp/kasa-stage5 \
//!     cargo run -p kasa-infrastructure --example offline_queue -- count

use kasa_infrastructure::offline::db::OfflineDatabase;
