...
use kasa_infrastructure::{db, repositories::write::SqlxWriteDirectories};
use uuid::Uuid;
...
async fn category_supplier_crud_flow() {
    ...
    let upd = kasa_domain::CategoryUpdateInput {
    ...
    let self_parent = kasa_domain::CategoryUpdateInput {
    ...
    let sup_upd = kasa_domain::SupplierUpdateInput {
