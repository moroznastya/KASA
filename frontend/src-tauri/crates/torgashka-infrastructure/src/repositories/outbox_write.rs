//! `OutboxWrite` — standby-адаптер write-гілки довідників та інвентаризації
...
//!     ці поверхні перехоплює гейт (`write_gate::proxy_to_primary`) і виконує
//!     їх на primary; адаптер standby до них не доходить. Якщо дійшов (виклик
//!     повз HTTP-шар) — явна відмова, а не запис у репліку.
//!
