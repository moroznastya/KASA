//! Torgashka — Application layer (етап 1 міграції).
//!
//! Use cases, порти (trait-контракти для інфраструктури), DTO.
//! Залежить ТІЛЬКИ від torgashka-domain — жодних Tauri/БД/апаратних залежностей.
//!
...
pub use services::invoices::{InvoicesV1Facade, InvoicesV2Facade};
