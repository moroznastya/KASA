...
//! [`torgashka_domain::InvoicesV1Service`] / [`torgashka_domain::InvoicesV2Service`].
...
impl<R: InvoicesV1Service> InvoicesV1Facade<R> {
    ...
    pub async fn payment_info(
        &self,
        id: Uuid,
    ) -> Result<torgashka_domain::invoices::InvoicePaymentInfoV1Dto, InvoicesError> {
...
impl<R: InvoicesV2Service> InvoicesV2Facade<R> {
    ...
    pub async fn payment_info(
        &self,
        id: Uuid,
    ) -> Result<torgashka_domain::invoices::InvoicePaymentInfoV2Dto, InvoicesError> {
