"""
Seed: Оновлення дефолтного шаблону receipt_58mm на новий стиль.
...
<body style="font-family: 'Arial', sans-serif; font-size: 12px; width: 48mm; margin: 0; padding: 0; color: #000; line-height: 1.2;">
    <div style="padding: 2px 4px;">
        ...
        <!-- Список товарів -->
        <div style="font-family: 'Courier New', Courier, monospace; font-size: 11px; width: 100%; margin: 4px 0;">
            {{items}}
        </div>
...
async def main():
    ...
    async with AsyncSession(engine) as session:
        ...
        await session.commit()  # ← виправлено: flush → commit
