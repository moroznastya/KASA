"""Seed: збільшення шрифтів у шапці чеку"""
import psycopg2
...
<body style="font-family: 'Arial', sans-serif; font-size: 12px; width: 48mm; margin: 0; padding: 0; color: #000; line-height: 1.2;">
    <div style="padding: 2px 4px;">
        ...
        <div style="text-align: center; margin-bottom: 10px;">
            ...
            <div style="font-size: 12px;">{{shop_address}}</div>
        ...
        <div style="text-align: center; font-size: 15px; font-weight: bold; margin: 6px 0;">
            ЧЕК № {{receipt_number}}
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 6px;">
            <tr>
                <td style="font-size: 16px; font-weight: bold; text-align: left;">ДО СПЛАТИ</td>
                <td style="font-size: 16px; font-weight: bold; text-align: right;">{{total}} грн</td>
            </tr>
        </table>
        ...
        <div style="text-align: center; font-size: 11px; margin-top: 4px; font-style: italic;">
